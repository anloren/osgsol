...
#include "project/earth_project.h"
...
struct OverlayLayer
{
    ...
    // Renderer-independent project metadata. Runtime objects and callbacks
    // remain outside the serialized descriptor, as do all credentials.
    earthproject::LayerSourceDescriptor source;
    earthproject::TemporalBinding temporal;
    earthproject::LayerCapabilities capabilities;
    std::string styleId;
    std::string legendId;
