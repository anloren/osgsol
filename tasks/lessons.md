...
工作目录：/Users/USER/osgverse，OSG 源码预克隆到 /Users/USER/OpenSceneGraph（Setup.sh 期望同级 ../OpenSceneGraph）。
...
## 运行注意
- 后台启动构建务必先 `cd /Users/USER/osgverse`（Bash 后台 shell cwd 可能被重置到 claudecode，导致 exit 127）。
