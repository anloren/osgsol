...
Run:
```bash
cmake --build /Users/USER/osgverse/build/verse_core --target install --config Release 2>&1 | tail -20
```
...
DYLD_LIBRARY_PATH=/Users/USER/osgverse/build/sdk_core/lib \
EARTH_QUAKES_FILE=/Users/USER/osgverse/applications/earth_explorer/test/quakes_fixture.geojson \
