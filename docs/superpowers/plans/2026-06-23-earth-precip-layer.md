...
Run: `cmake --build /Users/USER/osgverse/build/verse_core --target install --config Release 2>&1 | tail -6`
Expected: 成功,无报错。
...
DYLD_LIBRARY_PATH=/Users/USER/osgverse/build/sdk_core/lib \
EARTH_PRECIP_FILE=/Users/USER/osgverse/applications/earth_explorer/test/weather_maps_fixture.json \
...
cd /Users/USER/osgverse/build/sdk_core/bin && rm -f /tmp/earth_capture_0.png && \
DYLD_LIBRARY_PATH=/Users/USER/osgverse/build/sdk_core/lib \
EARTH_PRECIP=1 EARTH_PRECIP_FILE=/Users/USER/osgverse/applications/earth_explorer/test/weather_maps_fixture.json \
...
```bash
cd /Users/USER/osgverse/build/sdk_core/bin && \
DYLD_LIBRARY_PATH=/Users/USER/osgverse/build/sdk_core/lib ./osgVerse_EarthExplorer --resolution 1280 800
```
...
- [ ] **Step 3: 重打包 `.app`**
```bash
cd /Users/USER/osgverse && bash packaging/package_macos.sh 2>&1 | tail -1
```
